        ...
        <div class="container center_div">
            <div class="form-group">
                <div class="col-md-4 mb-3">
                    <label>BookID</label> <input type="text" class="form-control" placeholder="BookID" name="bookID"
                        required>
                </div>
                <div class="col-md-4 mb-3">
                    <label>ISBN</label> <input type="text" class="form-control" placeholder="ISBN" name="isbn" required>
                </div>
                <div class="col-md-4 mb-3">
                    <label>Title</label> <input type="text" class="form-control" name="title" placeholder="Title"
                        required>
                </div>
                <div class="col-md-4 mb-3">
                    <label>Editor</label> <input type="text" class="form-control" placeholder="Editor" name="editor"
                        required>
                </div>
                <div class="col-md-4 mb-3">
                    <label>Edition</label> <input type="text" class="form-control" placeholder="Edition" name="edition"
                        required>
                </div>
                <div class="col-md-4 mb-3">
                    <label>Year</label> <input type="text" class="form-control" placeholder="Year" name="year" required>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <label>Price</label> <input type="text" class="form-control" placeholder="Price" name="price"
                        required>
                </div>

                <div class="form-group col-md-4">
                    <label>Author's Name</label> <select class="form-control" name="authorName">
