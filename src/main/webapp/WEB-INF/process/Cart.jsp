                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" class="border-0">
                                    <div class="p-2">
                                        <img src="images/<%=book.getImage()%>" alt="" width="70"
                                            class="img-fluid rounded shadow-sm" />
                                        <div class="ml-3 d-inline-block align-middle" />
                                        <h5 class="mb-0">
                                            <a href="#"
                                                class="text-dark d-inline-block align-middle"><%=book.getTitle()%></a>
                                        </h5>
                                        <span class="text-muted font-weight-normal font-italic d-block">Author:
                                            <%=book.getAuthor().getAuthorfirstname()+" "+book.getAuthor().getAuthorlastname() %></span>
                                    </div>
                </th>
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled mb-4">
                    ...
                    <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Shipping
                            and handling</strong><strong>Free Shipping</strong></li>
