		...
		<div class="container center_div">
			<div class="form-group">
				<div class="col-md-4 mb-3">
					<label>Author ID</label> <input type="text" class="form-control"
						placeholder="Author ID" name="authorID" required>
				</div>
				<div class="col-md-4 mb-3">
					<label>Author's First Name</label> <input type="text"
						class="form-control" placeholder="First Name" name="firstName"
						required>
				</div>
				<div class="col-md-4 mb-3">
					<label>Author's Last Name</label> <input type="text"
